...
const MyQuestionCard = ({ title, author, time, answers, likes, tag, tagColor, isPublic, onEdit, onToggleVisibility, onDelete }) => {
    ...
    <div className="w-full bg-gray-950 rounded-lg p-6 mb-4 border border-gray-800 relative">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className={`bg-${tagColor}-900 text-${tagColor}-400 px-3 py-1 rounded-md text-sm font-medium`}>
            {tag}
          </div>
